...
func TestVerkkokauppa(t *testing.T) {
	...
	tests := []struct {
		...
		{"Fujtech", args{url: "https://www.verkkokauppa.com/fi/product/46243/msgsg/Fuj-tech-USB-Type-C-ulkoinen-kovalevykotelo-2-5-SATA-kovalev"}, "Fuj:tech USB Type-C -ulkoinen kovalevykotelo 2,5\" SATA-kovalevyille 33,90", false},
	}
