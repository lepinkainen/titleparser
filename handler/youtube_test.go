...
func TestYoutube(t *testing.T) {
	...
	tests := []struct {
		...
		{"Marvel 1", args{url: "https://www.youtube.com/watch?v=QdpxoFcdORI"}, `Marvel Studios Celebrates The Movies by Marvel Entertainment \[3m11s - \d+M views - \d+ (hours|days?|weeks?|months?) ago\]`, false},
		{"Marvel 1 - short", args{url: "https://youtu.be/QdpxoFcdORI"}, `Marvel Studios Celebrates The Movies by Marvel Entertainment \[3m11s - \d+M views - \d+ (hours|days?|weeks?|months?) ago\]`, false},
