...
func TestHackerNews(t *testing.T) {
	...
	tests := []struct {
		...
		{"Story 1", args{url: "https://news.ycombinator.com/item?id=23439437"}, "A List of Hacker News's Undocumented Features and Behaviors (2018) by billme [669 points]", false},
