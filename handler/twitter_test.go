...
func TestTwitter(t *testing.T) {
	...
	tests := []struct {
		...
		{"Foone 1 - image", args{url: "https://twitter.com/Foone/status/1389076911138115587"}, `foone \(@Foone\) \d+(w|m|h|d|y): and then I flashed it back. This thing is magic. https://t.co/4n8UxvEhvG \[. \d+ . \d+\]`, false},
		{"Foone 2 - video", args{url: "https://twitter.com/Foone/status/1250937428518436864"}, `foone \(@Foone\) \d+(w|m|h|d|y): So the show Shuriken Sentai Ninninger, the 39th show in the Super Sentai series \(which formed the basis for the Power Rangers shows\), had a monster named Yokai Mokumokuren, who is a supernaturally-infected computer keyboard. https://t.co/224u1P9iqb \[. \d+ . \d+\]`, false},
	}
